...
function rRules(ss){const nC=ss.config.courts;const names=ss.config.courtNames||defaultCourtNames(nC);
  ...
  <div class="card fu"><h3 class="card-t">Each round</h3><div class="rt-text"><p>Play the full round duration</p><p>When timer sounds, finish the rally</p><p>If tied at time, it's a tie</p><p>Receiving team makes line calls</p></div></div>`}
